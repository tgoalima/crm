...
ALTER TABLE public.negocios
  ...
  ADD COLUMN IF NOT EXISTS numero_proposta_oficial TEXT;
...
CREATE TABLE IF NOT EXISTS public.config_numeracao_propostas (
...
DROP POLICY IF EXISTS "Sel" ON public.config_numeracao_propostas;
