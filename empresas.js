  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/80 backdrop-blur-sm p-4" onClick={onClose}>
      <div className="bg-white dark:bg-slate-800 rounded-3xl w-full max-w-lg shadow-2xl ring-1 border border-slate-200 dark:border-slate-700 overflow-hidden max-h-[90vh] flex flex-col" onClick={e => e.stopPropagation()}>
        <div className="flex items-center gap-3 px-6 py-4 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-indigo-50/70 via-white to-white dark:from-indigo-950/40 dark:via-slate-800 dark:to-slate-800 shrink-0">
                    ...
                    {contasFiltradas.length > 0 && (
                      <div className="absolute z-20 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl mt-1 w-full max-h-48 overflow-y-auto shadow-2xl divide-y divide-slate-50">
                        {contasFiltradas.map(c => (
                          <div key={c.id} onClick={() => { setContaEscolhida(c); setBuscaConta(''); }} className="px-4 py-2.5 hover:bg-indigo-50/80 dark:hover:bg-indigo-950/50 cursor-pointer flex items-center gap-2.5 transition-colors">
    ...
    <div className="fixed inset-0 z-50 flex justify-end bg-slate-950/60 backdrop-blur-xs" onClick={onClose}>
      <div className="w-full max-w-2xl bg-white dark:bg-slate-800 h-full flex flex-col shadow-2xl border-l border-slate-200 dark:border-slate-700" onClick={e => e.stopPropagation()}>
        ...
        <div className="shrink-0 border-b border-slate-100 dark:border-slate-800">
          <div className="px-6 pt-5 pb-3">
            <div className="flex items-start gap-4">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <button onClick={() => onExcluirEmpresa(conta)} title="Excluir esta empresa" className="flex items-center gap-1.5 px-2 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-rose-950/40 text-slate-400 dark:text-slate-500 hover:text-rose-600 dark:hover:text-rose-400 hover:border-rose-300 dark:hover:border-rose-800 transition-all shadow-xs cursor-pointer">
                  <IconTrash size={13} />
                </button>
          ...
          <div className="p-4 bg-gradient-to-b from-slate-100 to-slate-100/60 dark:from-slate-900 dark:to-slate-900/40 border-t border-slate-200 dark:border-slate-700">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              {/* Card 1: Ganhos */}
              <div className="bg-white dark:bg-slate-800 p-3 rounded-2xl border border-slate-200 dark:border-slate-700 border-t-2 border-t-emerald-400 dark:border-t-emerald-600 shadow-sm shadow-slate-200/60 flex flex-col justify-between">
              ...
              {/* Card 2: Pipeline */}
              <div className="bg-white dark:bg-slate-800 p-3 rounded-2xl border border-slate-200 dark:border-slate-700 border-t-2 border-t-indigo-400 dark:border-t-indigo-600 shadow-sm shadow-slate-200/60 flex flex-col justify-between">
                <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="bg-white dark:bg-slate-800 p-3 rounded-2xl border border-slate-200 dark:border-slate-700 border-t-2 border-t-slate-300 dark:border-t-slate-600 shadow-sm shadow-slate-200/60 flex flex-col justify-between">
                <div className="flex items-center justify-between mb-1.5">
              ...
              <div className={`bg-white dark:bg-slate-800 p-3 rounded-2xl border border-slate-200 dark:border-slate-700 border-t-2 shadow-sm shadow-slate-200/60 flex flex-col justify-between ${kpis.taxa >= 60 ? 'border-t-emerald-400 dark:border-t-emerald-600' : kpis.taxa > 0 ? 'border-t-amber-400 dark:border-t-amber-600' : 'border-t-slate-300 dark:border-t-slate-600'}`}>
                <div className="flex items-center justify-between mb-1.5">
            ...
            <div className="p-5 space-y-4">
              <div className="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm shadow-slate-200/50 overflow-hidden">
                <div className="flex items-center justify-between px-5 py-3 border-b border-slate-200 dark:border-slate-700 bg-slate-100/80 dark:bg-slate-700/80">
                  ...
                  <button onClick={() => onEditarEmpresa(conta)} className="flex items-center gap-1 text-[11px] font-bold text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 dark:hover:text-indigo-300 cursor-pointer"><IconEdit size={11} /> Editar</button>
                </div>
                ...
                <div className="p-4">
                  ...
                  {(conta.cidade || conta.estado) && (
                    <p className="text-xs text-slate-500 dark:text-slate-400 font-medium mb-2.5 flex items-center gap-1">
                      <IconMapPin size={11} className="text-slate-300 dark:text-slate-600" />{[conta.cidade,conta.estado].filter(Boolean).join(', ')}
                    </p>
                  )}
