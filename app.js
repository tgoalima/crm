        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto flex-1 space-y-4">
          ...
          {oportunidadeSelecionada ? (
            ...
            <div className="relative">
              ...
              {dropdownAberto && (
                <div className="absolute top-full left-0 right-0 mt-1 max-h-56 overflow-y-auto bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl shadow-xl z-20 divide-y divide-slate-100 dark:divide-slate-700">
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Resumo rápido */}
        <div className="px-6 py-3 bg-slate-50 dark:bg-slate-800 border-b border-slate-100 dark:border-slate-700 flex flex-wrap items-center justify-between gap-4 text-xs">
          ...
          {loading ? (
            ...
            ros.map((ro, index) => {
              ...
              return (
                <div
                  key={ro.id || index}
                  className="p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 hover:border-purple-200 dark:hover:border-purple-900/60 transition-all text-xs space-y-2.5"
                >
        ...
        <div className="p-4 px-6 border-t border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 flex items-center justify-between gap-3">
...
function RegistrosOportunidadeView({
  ...
  return (
    <div className="w-full flex-none flex flex-col bg-slate-50 dark:bg-slate-900">
      {/* 1. Header do Módulo */}
      <div className="px-4 py-4 bg-white dark:bg-slate-800 border-b border-slate-200/80 dark:border-slate-700 flex flex-col md:flex-row md:items-center justify-between gap-3">
        <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            onClick={onRefresh}
            disabled={loading}
            className="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 rounded-lg transition-colors cursor-pointer border border-slate-200 dark:border-slate-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:opacity-50"
      ...
      <div className="px-4 pt-3 pb-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        {/* Total Filtrado */}
        <div className="p-3.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-200/80 dark:border-slate-700 shadow-xs flex flex-col justify-between">
      ...
      <div className="px-4 pt-2 pb-3">
        <div className="bg-white dark:bg-slate-800 p-3 rounded-xl border border-slate-200/80 dark:border-slate-700 shadow-xs flex flex-wrap items-center gap-2.5">
          {/* Busca Textual Ampla */}
      ...
      <div className="px-4 flex flex-col mb-4">
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200/80 dark:border-slate-700 shadow-xs flex flex-col overflow-hidden">
          {/* Mensagem de Erro */}
          {error && (
            ...
            <div className="p-3 px-4 border-t border-slate-200 dark:border-slate-800 bg-slate-50/60 dark:bg-slate-900/40 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-semibold hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors disabled:opacity-40 disabled:cursor-not-allowed cursor-pointer focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
                  ← Anterior
                </button>
                <button
